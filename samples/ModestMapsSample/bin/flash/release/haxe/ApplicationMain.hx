...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "9",
			company: "",
			file: "ModestMapsSample",
			fps: 30,
			name: "ModestMapsSample",
			orientation: "",
			packageName: "com.modestmaps.sample.ModestMapsSample",
			version: "1.0.0",
			windows: [
	...
	macro public static function getEntryPoint () {
		...
		switch (Context.follow (Context.getType ("ModestMapsSample"))) {
			...
			case TInst (t, params):
				...
				if (hasMain) {
					...
					return Context.parse ("@:privateAccess ModestMapsSample.main ()", Context.currentPos ());
					...
					Context.fatalError ("Main class \"ModestMapsSample\" has neither a static main nor a constructor.", Context.currentPos ());
					
				}
				
			default:
				
				Context.fatalError ("Main class \"ModestMapsSample\" isn't a class.", Context.currentPos ());
...
@:keep class DocumentClass extends ModestMapsSample {}
